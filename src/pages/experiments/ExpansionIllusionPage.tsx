...
export const ExpansionIllusionPage: React.FC = () => {
  React.useEffect(() => {
    window.scrollTo(0, 0);
    markPageAsVisited('/experiences-pensee-echelles/illusion-expansion');
  }, []);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 relative z-10">
        ...
        <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8 lg:space-y-10">
          ...
          <div className="bg-gradient-to-br from-pink-900/40 to-red-900/30 backdrop-blur-sm rounded-xl lg:rounded-2xl p-6 sm:p-8 border border-pink-400/30 shadow-2xl">
            <h2 className="text-2xl sm:text-3xl font-bold text-pink-300 mb-4 sm:mb-6">La Loi de Hubble Réinterprétée</h2>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-gradient-to-r from-pink-900/40 to-purple-900/30 p-4 sm:p-6 rounded-lg border-l-4 border-pink-400">
                <h3 className="text-lg font-semibold text-pink-200 mb-3">Un Changement de Paradigme</h3>
                <p className="text-sm sm:text-base text-gray-200 leading-relaxed">
                  Au lieu d'un univers en expansion dans un espace qui grandit, nous avons <strong className="text-white">un univers en contraction d'échelle, où chaque objet plonge vers l'infiniment petit à son propre rythme</strong>. Le résultat observationnel est identique, mais l'interprétation physique est radicalement différente.
                </p>
              </div>
            </div>
          </div>
