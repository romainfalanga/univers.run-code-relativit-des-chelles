...
export const RestrictedScaleRelativityHubPage: React.FC = () => {
  ...
  const navigationCards = [
    ...
    {
      title: "Situation 1 : Presque Immobile",
      description: "Budget temps maximum avec graphiques et barres de progression",
      path: "/relativite-restreinte-echelles/presque-immobile",
      colorFrom: "from-green-900/40",
      colorTo: "to-emerald-900/30",
      borderColor: "border-green-400"
    },
    {
      title: "Situation 2 : Vitesse Extrêmement Rapide",
        ...
        <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl lg:rounded-2xl p-6 sm:p-8 border border-white/20 shadow-2xl mb-8">
            <p className="text-base sm:text-lg text-gray-200 leading-relaxed text-center">
              Einstein avait montré que notre mouvement se partage entre l'espace et le temps. Dans ce modèle, ce partage s'étend : il existe un <strong className="text-white">budget universel</strong>, découpé en deux comptes reliés par le même pivot : le curseur temps.
            </p>
          </div>
